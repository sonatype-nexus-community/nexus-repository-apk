...
@Named
@Singleton
@Path(RepositoriesApiResource.RESOURCE_URI + "/apk/proxy")
public class ApkProxyRepositoriesApiResource extends AbstractRepositoriesApiResource<ApkProxyRepositoryApiRequest>
{
    @Inject
    public ApkProxyRepositoriesApiResource(
            final AuthorizingRepositoryManager authorizingRepositoryManager,
            final AbstractRepositoryApiRequestToConfigurationConverter<ApkProxyRepositoryApiRequest> configurationAdapter)
    {
        super(authorizingRepositoryManager, configurationAdapter);
    }
    @ApiOperation("Create APK proxy repository")
    @ApiResponses(value = {
    ...
    @Validate
    @Override
    public Response createRepository(final ApkProxyRepositoryApiRequest request) {
        return super.createRepository(request);
    }

    @ApiOperation("Update APK proxy repository")
    @ApiResponses(value = {
    ...
    public Response updateRepository(
            final ApkProxyRepositoryApiRequest request,
